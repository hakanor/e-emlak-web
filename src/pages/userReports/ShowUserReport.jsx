...
const ShowUserReports = () => {
  ...
  useEffect(() => {
    const fetchReportData = async () => {
      try {
        const report = await FirebaseService.get('userReports', id);
  ...
  const handleDeleteReport = async () => {
    ...
    if (confirmed) {
      try {
        ...
        await FirebaseService.delete('userReports', reportData.id);
  ...
  const toggleStatus = async () => {
    try {
      ...
      const updatedReport = await FirebaseService.update('userReports', id, {
...
export default ShowUserReports;
